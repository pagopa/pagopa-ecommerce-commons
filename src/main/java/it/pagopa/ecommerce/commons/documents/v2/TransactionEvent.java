...
public abstract sealed class TransactionEvent<T> extends
        BaseTransactionEvent<T> permits BaseTransactionClosureEvent, TransactionActivatedEvent, TransactionAuthorizationCompletedEvent, TransactionAuthorizationRequestedEvent, TransactionAuthorizationRequestedRetriedEvent, TransactionClosureErrorEvent, TransactionClosureRequestedEvent, TransactionClosureRetriedEvent, TransactionExpiredEvent, TransactionRefundErrorEvent, TransactionRefundRequestedEvent, TransactionRefundRetriedEvent, TransactionRefundedEvent, TransactionUserCanceledEvent, TransactionUserReceiptAddErrorEvent, TransactionUserReceiptAddRetriedEvent, TransactionUserReceiptAddedEvent, TransactionUserReceiptRequestedEvent {
