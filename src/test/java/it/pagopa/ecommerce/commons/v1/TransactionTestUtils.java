...
public class TransactionTestUtils {
    ...
    @Nonnull
    public static TransactionWithRequestedUserReceipt transactionWithRequestedUserReceipt(BaseTransactionClosed baseTransactionClosed,
                                                                                          TransactionSendUserReceiptEvent transactionSendUserReceiptEvent) {
        return new TransactionWithRequestedUserReceipt(baseTransactionClosed, transactionSendUserReceiptEvent);
    }

    @Nonnull
    public static TransactionSendUserReceiptEvent transactionSendUserReceiptEvent(TransactionUserReceiptData transactionUserReceiptData) {
        return new TransactionSendUserReceiptEvent(
                TRANSACTION_ID,
