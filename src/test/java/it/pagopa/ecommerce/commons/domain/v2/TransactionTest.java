...
class TransactionTest {
    ...
    void shouldConstructTransactionFromAuthorizedEventStream() {
        ...
        TransactionAuthorizationCompletedEvent transactionAuthorizationCompletedEvent = TransactionTestUtils
                .transactionAuthorizationCompletedEvent(
                        TransactionTestUtils.pgsTransactionAuthorizationCompletedData(AuthorizationResultDto.OK)
                );
    ...
    void transactionAuthorizedHasCorrectStatus() {
        ...
        assertEquals(
                ...
                ((PgsTransactionAuthorizationCompletedData) transactionAuthorizationCompleted
                        .getTransactionAuthorizationCompletedData().getTransactionAuthorizationCompletedData())
    ...
    void shouldConstructTransactionUnauthorizedFromAuthorizationCompletedStream() {
        ...
        TransactionAuthorizationCompletedEvent transactionAuthorizationCompletedEvent = TransactionTestUtils
                .transactionAuthorizationCompletedEvent(
                        TransactionTestUtils.pgsTransactionAuthorizationCompletedData(AuthorizationResultDto.KO)
                );
